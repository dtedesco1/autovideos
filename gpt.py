...
responses_prompt = f"Respond to the following questions as if you were Abraham Lincoln:\n\n{'\\n'.join(generated_questions)}"
...
dalle_prompt = f"Generate a Stable Diffusion or Midjourney prompt for each of the following questions and responses for Abraham Lincoln:\n\n{'\\n'.join(f'{q}: {r}' for q, r in zip(generated_questions, generated_responses))}"
